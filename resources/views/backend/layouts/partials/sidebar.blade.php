<nav class="side-nav">
    <a href="{{route('dashboard')}}" class="intro-x flex items-center pl-5 pt-4">
        <i data-feather="help-circle" style="color: white"></i>
        <span class="hidden xl:block text-white text-lg ml-1">Que<span class="font-medium"><view>View</view></span> </span>
    </a>
    ...
    <ul>
        ...
        <li>
            <a href="{{route('my-bookmark')}}" class="side-menu">
                <div class="side-menu__icon"><i data-feather="bookmark"></i></div>
                <div class="side-menu__title"> My Bookmarks</div>
            </a>
        </li>
                ...
                <a href="javascript:" class="side-menu
                    ...
                    <div class="side-menu__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             ...
                             class="feather feather-award mx-auto">
                            <circle cx="12" cy="8" r="7"></circle>
                            <polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>
                        </svg>
                    </div>
                    <div class="side-menu__title"> Roles <i data-feather="chevron-down" class="side-menu__sub-icon"></i>
                    </div>
                </a>
                <ul class="">
                    <li>
                        <a href="{{ route('dashboard') }}/roles" class="side-menu">
                            <div class="side-menu__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     ...
                                     stroke-linejoin="round" class="feather feather-list mx-auto">
                ...
                <ul class="">
                    ...
                    <li>
                        <a href="{{ route('question-request-view') }}" class="side-menu">
                            ...
                            <div class="side-menu__title"> Question Requests</div>
                        </a>
                    </li>
        ...
        @if (Auth::guard('admin')->user()->can('admin.view'))
            <li>
                <a href="javascript:" class="side-menu
                    ...
                    <div class="side-menu__title"> Admins <i data-feather="chevron-down"
